...
namespace JukaCompiler.RoslynCompile
{
    ...
    class GenerateBinaryExpression
    {
        ...
        internal static CSharpSyntaxNode CreateBinaryExpression(ParserRuleContext context, JukaRoslynVisitor visitor)
        {
            return null;
        }
        ...
        internal GenerateBinaryExpression Walk(ParserRuleContext node)
        {
            ...
            //        if (node is JukaGrammarParser.CombinedExpressionsContext ||
            //            node is JukaGrammarParser.VariableDeclarationAssignmentContext ||
            //            node is JukaGrammarParser.BinaryOpAndDoubleExpressionContext ||
            //            node is JukaGrammarParser.BinaryOpAndSingleExpressionContext ||
            //            node is JukaGrammarParser.BinaryExpressionContext)

            //        {
            //            return this;
            //        }
            //        else if (node is JukaGrammarParser.LeftParenContext)
            //        {
            //            operators.Push(node);
            //            return this;
            //        }
            //        else if (node is JukaGrammarParser.RightParenContext)
            //        {
            //            while (!(operators.Peek() is JukaGrammarParser.LeftParenContext))
            //            {
            ...
            //            operators.Pop();
            //        }
            //        else if (node is JukaGrammarParser.VariableContext)
            //        {
            //            postfix.Add(node);
            //            return this;
            //        }
            //        else if (node is JukaGrammarParser.KeywordsContext)
            //        {
            //            currentKeyWord = node;
            //            return this;
            //        }
            //        else if (node is JukaGrammarParser.VariableDeclarationContext)
            //        {
            //            return this;
            //        }
            //        else if (node is JukaGrammarParser.AssignmentOperatorContext)
            //        {
            ...
            //        }
            //        else if (node is JukaGrammarParser.IntValueContext)
            //        {
            //            postfix.Add(node);
            //            return this;
            //        }
            //        else if (
            //            node is JukaGrammarParser.BinaryOperatorContext ||
            //            node is JukaGrammarParser.AddSubtractOpContext ||
            //            node is JukaGrammarParser.MultiplyDivideOpContext)
            //        {
            //            if (operators.Count == 0)
            //            {
            //                operators.Push(node);
