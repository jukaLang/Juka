...
using JukaCompiler.Tokens;
using System.Linq.Expressions;
using System.Reflection;


namespace JukaCompiler.Visitors
{
    /*using JukaCompiler.Grammar;
    ...
    internal class JukaVisitor : JukaGrammarBaseVisitor<Expression>
    {
        ...
        public override Expression VisitCompileUnit(JukaGrammarParser.CompileUnitContext context)
        {
        ...
        public override Expression VisitStatement(JukaGrammarParser.StatementContext context)
        {
            return base.VisitStatement(context);
        }

        public override Expression VisitAdd(JukaGrammarParser.AddContext context)
        {
            return base.VisitAdd(context);
        }

        public override Expression VisitAssignmentExpression(JukaGrammarParser.AssignmentExpressionContext context)
        {
            return base.VisitAssignmentExpression(context);
        }

        public override Expression VisitAssignmentOperator(JukaGrammarParser.AssignmentOperatorContext context)
        {
            return base.VisitAssignmentOperator(context);
        }

        public override Expression VisitBinaryExpression(JukaGrammarParser.BinaryExpressionContext context)
        {
        ...
        public override Expression VisitBooleanExpression(JukaGrammarParser.BooleanExpressionContext context)
        {
            var expressions = new List<Expression>();
            foreach (var t in context.children)
            {
        ...
        public override Expression VisitClassifications(JukaGrammarParser.ClassificationsContext context)
        {
            return base.VisitClassifications(context);
        }

        public override Expression VisitLiteral(JukaGrammarParser.LiteralContext context)
        {
        ...
        public override Expression VisitEqualsign(JukaGrammarParser.EqualsignContext context)
        {
            return base.VisitEqualsign(context);
        }

        public override Expression VisitEqualequal(JukaGrammarParser.EqualequalContext context)
        {
            return base.VisitEqualequal(context);
        }

        public override Expression VisitEqualityExpression(JukaGrammarParser.EqualityExpressionContext context)
        {
            return base.VisitEqualityExpression(context);
        }

        public override Expression VisitExpression(JukaGrammarParser.ExpressionContext context)
        {
            ...
            return null;
            //return new JukaMulitipleVariableExpressions(t);
        }

        public override Expression VisitEndLine(JukaGrammarParser.EndLineContext context)
        {
            var endline = Expression.Constant(context.GetText());
            return endline;
        }

        public override Expression VisitEvaluatable(JukaGrammarParser.EvaluatableContext context)
        {
        ...
        public override Expression VisitVariableDeclaration(JukaGrammarParser.VariableDeclarationContext context)
        {
            return base.VisitVariableDeclaration(context);
        }

        public override Expression VisitVariableDeclarationExpression(
            JukaGrammarParser.VariableDeclarationExpressionContext context)
        {
            ...
            var mulitipleExpressions = new JukaMulitipleVariableExpressions();
        ...
        private void GenerateBinaryIntExpression(JukaGrammarParser.VariableDeclarationExpressionContext context, string variableName,
        ...
        public override Expression VisitVariable(JukaGrammarParser.VariableContext context)
        {
            return base.VisitVariable(context);
        }

        public override Expression VisitExpressionSequence(JukaGrammarParser.ExpressionSequenceContext context)
        {
            return base.VisitExpressionSequence(context);
        }

        public override Expression VisitFuncName(JukaGrammarParser.FuncNameContext context)
        {
            return Expression.Constant(context.GetText());
        }

        public override Expression VisitFunctionDeclaration(JukaGrammarParser.FunctionDeclarationContext context)
        {
            ...
            foreach (var parm in expressionList)
            {
                ...
                if (parm is JukaMulitipleVariableExpressions itemExpression)
                {
                ...
                if (parm is JukaMethodCall JukaMethodCall )
                {
                    expressionsToAdd.Add( JukaMethodCall );
                    expressionsToAdd.Add(Expression.Label(JukaMethodCall.ReturnTarget));
                    expressionsToAdd.Add(Expression.Goto(JukaMethodCall.ReturnTarget));
                    continue;
                }
       ...
       /* public override Expression VisitFunctionCall(JukaGrammarParser.FunctionCallContext context)
        {
            ...
            JukaMethodCall JukaMethodCall = new JukaMethodCall(
                functionCallName, 
                null, 
                null, 
                highLevelFunctions,
            ...
            return JukaMethodCall;

            //return new PrintExpression(functionCallName);
        }

        public override Expression VisitFunctionCallExpression(JukaGrammarParser.FunctionCallExpressionContext context)
        {
        ...
        public override Expression VisitIdentifierName(JukaGrammarParser.IdentifierNameContext context)
        {
            Expression[] t = new Expression[context.ChildCount];
            for (int i = 0; i < context.ChildCount; i++)
            {
    ...
    internal class JukaMethodCall : Expression
    {
        ...
        public JukaMethodCall(string methodName, ParameterExpression[] inputParameters, ParameterExpression returnParameters, Dictionary<string, LabelTarget> highLevelFunctions, LabelTarget label)
        {
    ...
    internal class JukaMulitipleVariableExpressions : Expression
    {
