...
namespace JukaCompiler.Visitors
{
    ...
    class JukaRoslynVisitor 
    {
    //    public override CSharpSyntaxNode VisitCompileUnit([NotNull] JukaGrammarParser.CompileUnitContext context)
    //    {
    ...
    //    }
        ...
        //public override CSharpSyntaxNode VisitFunctionDeclaration([NotNull] JukaGrammarParser.FunctionDeclarationContext context)
        //{
        ...
        /*
        public override CSharpSyntaxNode VisitAssignmentExpression([NotNull] JukaGrammarParser.AssignmentExpressionContext context)
        {
            return base.VisitAssignmentExpression(context);
        }
        */

        //public override CSharpSyntaxNode VisitFunctionCall([NotNull] JukaGrammarParser.FunctionCallContext context)
        //{
        ...
        //public override CSharpSyntaxNode VisitVariable([NotNull] JukaGrammarParser.VariableContext context)
        //{
        //    return SyntaxFactory.Argument(SyntaxFactory.IdentifierName(context.ID().GetText()));
        //    //return base.VisitVariable(context);
        //}

        //public override CSharpSyntaxNode VisitFunctionCallExpression([NotNull] JukaGrammarParser.FunctionCallExpressionContext context)
        //{
        //    var node = base.VisitFunctionCallExpression(context);
        //    return node;
        //}

        //public override CSharpSyntaxNode VisitStatement([NotNull] JukaGrammarParser.StatementContext context)
        //{
        //    var node = base.VisitStatement(context);
        //    return node;
        //}

        //public override CSharpSyntaxNode VisitExpression([NotNull] JukaGrammarParser.ExpressionContext context)
        //{
        ...
        //public override CSharpSyntaxNode VisitStringValue([NotNull] JukaGrammarParser.StringValueContext context)
        //{
        ...
        //public override CSharpSyntaxNode VisitParameterVariableDeclaration([NotNull] JukaGrammarParser.ParameterVariableDeclarationContext context)
        //{
        ...
        //public override CSharpSyntaxNode VisitKeywords([NotNull] JukaGrammarParser.KeywordsContext context)
        //{
        ...
        //public override CSharpSyntaxNode VisitVariableDeclarationAssignment([NotNull] JukaGrammarParser.VariableDeclarationAssignmentContext context)
        //{
        ...
        //public override CSharpSyntaxNode VisitCombinedExpressions([NotNull] JukaGrammarParser.CombinedExpressionsContext context)
        //{
        //    var binaryExpression = new GenerateBinaryExpression();
        ...
        //public override CSharpSyntaxNode VisitVariableDeclarationExpression([NotNull] JukaGrammarParser.VariableDeclarationExpressionContext context)
        //{
        ...
        //public override CSharpSyntaxNode VisitIfExpr([NotNull] JukaGrammarParser.IfExprContext context)
        //{
        //    var ifExpression = new GenerateIfStatement();
        //    return ifExpression.Walk(context, this);
        //}

        //public override CSharpSyntaxNode VisitAssignmentOperator([NotNull] JukaGrammarParser.AssignmentOperatorContext context)
        //{
        ...
        /*
        public override CSharpSyntaxNode VisitDecimalValue([NotNull] JukaGrammarParser.DecimalValueContext context)
        {
            try
            {
        ...
        */
        ...
        //public override CSharpSyntaxNode VisitIntValue([NotNull] JukaGrammarParser.IntValueContext context)
        //{
        ...
        //public override CSharpSyntaxNode VisitLiteral([NotNull] JukaGrammarParser.LiteralContext context)
        //{
        //    var literal = SyntaxFactory.LiteralExpression(SyntaxKind.NumericLiteralExpression, SyntaxFactory.Literal(context.GetText()));
        //    return literal;
        //}

        //public override CSharpSyntaxNode VisitNumericTypes([NotNull] JukaGrammarParser.NumericTypesContext context)
        //{
